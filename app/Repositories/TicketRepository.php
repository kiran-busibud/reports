...
class TicketRepository
{
    ...
    {
        $query = "SELECT * FROM hl_ticket WHERE 1 = 1";
    ...
    function getUnresolvedTicketsByPendingTimeListView()
    {
        ...
        $query = "SELECT 
            CASE 
                ...
                WHEN TIMESTAMPDIFF(HOUR, ticket_date, CURRENT_DATE()) BETWEEN 13 AND 24 THEN '12-24 hrs'
                ELSE '24 hrs+'
            END AS hrs_range FROM hl_ticket WHERE 1 = 1";
    ...
    function getUnresolvedTicketsByMostBackAndForth()
    {
        ...
        $query =
            ...
            CASE 
                ...
                WHEN count_messages BETWEEN 3 AND 4 THEN '3-4'
                WHEN count_messages BETWEEN 5 AND 8 THEN '5-8'
                ELSE '8+'
            END AS message_count_range, 
            SUM(t.agent_messages) AS agent_messages,
            SUM(t.customer_messages) AS customer_messages
                FROM (
                    SELECT 
